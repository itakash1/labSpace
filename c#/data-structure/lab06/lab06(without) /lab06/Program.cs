...
{
    public delegate void TestFunctionProgramMenu();

    public static List<IVectorable> arr = new List<IVectorable>();
    ...
    public static void Main(string[] args)
    {
        ...
        menu();
        Console.WriteLine("Программа завершила свое выполнение отработав без ошибок \ud83e\udd21");
        Console.ReadKey();
    }
    ...
    public static void VectorsMinAndMaxCountCoordinates()
    {
        try
        {
    ...
    public static void SortArrayVectorsForUpsModules()
    {
        IVectorable temp;
    ...
    public static void SummVectors()
    {
    ...
    public static void ModuleVectors()
    {
    ...
    public static void ScalarMultVectors()
    {
